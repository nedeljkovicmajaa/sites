...
<div class="row top-bar">
    ...
    <div class="col-sm-5 d-sm-block d-none" style="font-size: 13px">
        <i class="fa fa-envelope"></i> selic73@gmail.com &nbsp;
        <i class="fa fa-phone"></i> 
        <i class="fa fa-comments"></i>  0637419765 &nbsp;&nbsp;
        <a href="https://www.facebook.com/SELIC-BOIS-104902084354995/" style="color: #ffffff" > <i class="fa fa-facebook-square"></i> SELIC-BOIS </a>
    </div>
...
<nav class="navbar navbar-expand-lg nav-bar navbar-light bg-light">
    <div class="container">
        <a class="navbar-brand" > SELIC <span class="navbar-brand2"> -</span> <span class="navbar-brand" href="#"> BOIS</span> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto navi">
                <li class="nav-item">
                    <a class="nav-link nav-btn active" href="#">POČETAK</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-btn" href="#fh5co-pricing">RADOVI</a>
                </li>
        
                <li class="nav-item">
                    <a class="nav-link nav-btn" href="#">PREPORUKE</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-btn" href="#fh5co-contact">KONTAKT</a>
                </li>
            </ul>
        </div>
    </div>
...
<div>
    <img class="banner d-none d-sm-block" src="wordpress.jpg">
    <div class="banner-text d-none d-sm-block animate-box" data-animate-effect="fadeInLeft">
     <h2> UREDI SVOJU <br> KUĆU IZ SNOVA</h2>
        <div >Kompletna renovacija objekata. </div>
    </div>
...
<div>
    <div class="row aft-banner">
        ...
        <div class="g-box"><img width=100% height=100% src="a22.jpg"></div>
        </div>
        <div class="col-1"></div>
        <div class="col-sm-4 d-none d-md-block">
            <div class="domains">SELIC - BOIS</div>
            <div class="text-center orange">nameštaj i stolarija</div>
        </div>
        <div class="col-" ></div>
        <div class="col-sm-3">
            <div class="input-group">
                <input type="text" class="form-control dark-bg" placeholder="Domain name">
                <div class="input-group-append">
                    ...
                    <button class="btn btn-outline-secondary btn-org" type="button">Go</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="white">
    <div class="container" id="fh5co-features">
        <div class="heading animate-box"><h2><b><span class="text-org">ZAŠTO<span class="text-gr"> BAŠ</span> <span class="text-org"> MI </span><span class="text-gr"> ?</span></b></h2>
        </div>
        <br><br>
        <div class="row">
            <div class="col-sm-4 animate-box" data-animate-effect="fadeIn">
                <div class="bordery">
                    <i class="fa fa-server text-gr bfont" aria-hidden="true"></i> <b>Unikatni</b>
            ...
            <div class="col-sm-4 animate-box" data-animate-effect="fadeIn">
                <div class="bordery">
                    <i class="fa fa-server text-gr bfont" aria-hidden="true"></i> <b>Strpljivi</b>
                    <div class="features">Get amazing results working with the best programmers, designers, writers and
                        other top online pros. You can hire us with confidence. Get amazing results working with the
                        best programmers...
                    </div>
            ...
            <div class="col-sm-4 animate-box" data-animate-effect="fadeIn">
                <div class="bordery" style="border-right: 0px;">
                    <i class="fa fa-server text-gr bfont" aria-hidden="true"></i> <b>Temeljni</b>
                    <div class="features">Get amazing results working with the best programmers, designers, writers and
                        other top online pros. You can hire us with confidence. Get amazing results working with the
                        best programmers...
                    </div>
            ...
            <div class="col-sm-4 animate-box">
                <div class="bordery" style="border-bottom: 0px;">
                    <i class="fa fa-server text-gr bfont" aria-hidden="true"></i> <b>  Iskusni</b>
                    <div class="features">Get amazing results working with the best programmers, designers, writers and
                        other top online pros. You can hire us with confidence. Get amazing results working with the
                        best programmers...
                    </div>
            ...
            <div class="col-sm-4 animate-box">
                <div class="bordery" style="border-bottom: 0px">
                    <i class="fa fa-server text-gr bfont" aria-hidden="true"></i> <b>Kvalitetni</b>
                    <div class="features">Get amazing results working with the best programmers, designers, writers and
                        other top online pros. You can hire us with confidence. Get amazing results working with the
                        best programmers...
                    </div>
            ...
            <div class="col-sm-4 animate-box">
                <div class="bordery" style="border-right: 0px; border-bottom: 0px">
                    <i class="fa fa-server text-gr bfont" aria-hidden="true"></i> <b>Pristupačni</b>
                    <div class="features">Get amazing results working with the best programmers, designers, writers and
                        other top online pros. You can hire us with confidence. Get amazing results working with the
                        best programmers...
                    </div>
...
<div class="white">
    <div class="container" id="fh5co-reviews">
        <div class="heading animate-box"><h2><b>VLASNIK FIRME</b></h2></div>
        <div class="text-center animate-box"><h3>Miloš Nedeljković</h3></div>
...
<div class="smoke">
    <div class="container" id="fh5co-contact">
        <div class="heading animate-box"><h2><b>KONTAKTIRAJTE NAS</b></h2></div>
        <div class="text-center animate-box"><h4>Miloš Nedeljković</h4></div>
        <div class="row animate-box">
            ...
            <div class="col-md-6">
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Unesite ime">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Email</label>
                        <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Unesite vaš email">
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Tekst</label>
                        <textarea class="form-control" rows="5" placeholder="Unesite poruku ovde"></textarea>
                    </div>
                    <button class="btn btn-banner">Pošalji</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="darker">
    ...
    <div class="d-sm-block d-none" style="font-size: 13px">
     &nbsp;&nbsp;
     <i class="fa fa-envelope"style="color: #ffffff"> selic73@gmail.com</i>  &nbsp;
        <i class="fa fa-envelope"style="color: #ffffff"> selic73@gmail.com</i>  &nbsp;
        <i class="fa fa-phone"style="color: #ffffff"></i> 
        <i class="fa fa-comments" style="color: #ffffff"> 0637419765</i>   &nbsp;&nbsp;
        <a href="https://www.facebook.com/SELIC-BOIS-104902084354995/" style="color: #ffffff" > <i class="fa fa-facebook-square"></i> SELIC-BOIS </a>
        <i class="col-sm-3 "  style="color: #ffffff "> Kraljevo, Srbija </i>
    </div>
