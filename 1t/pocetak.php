...
<div class="w3-top w3-content">
  <div class="w3-row w3-padding w3-black ">
    <div class="w3-col s3">
      <a href="#vrh" class="w3-button w3-block w3-black">POČETAK</a>
    </div>
    <div class="w3-col s3">
      <a href="#onama" class="w3-button w3-block w3-black">O NAMA</a>
    </div>
    <div class="w3-col s3">
      <a href="#radovi" class="w3-button w3-block w3-black">RADOVI</a>
    </div>
    <div class="w3-col s3">
...
<header class="w3-display-container " id="vrh">
  ...
  <div class="w3-display-bottomleft w3-padding-large">
    ...
    <a class="w3-button w3-darkgray w3-round w3-hide-small w3-hover-light-grey" onclick="window.location.href = 'http://localhost:8000/commencement.php';">FR<i class="fa fa-angle-right"></i></a><br>
...
<!-- onama Container -->
<div class="w3-container" id="onama">
  <div class="w3-content" style="max-width:700px">
    ...
    <p>In addition to our full espresso and brew bar radovi, we serve fresh made-to-order breakfast and lunch sandwiches, as well as a selection of sides and salads and other good stuff.</p>
    
  </div>
</div>

<!-- radovi Container -->
<div class="w3-container" id="radovi">
  <div class="w3-content" style="max-width:700px">
 
    <h5 class="w3-center w3-padding-48"><span class="w3-tag w3-wide">RADOVI</span></h5>
  
    <div class="w3-row w3-center w3-card w3-padding">
      <a href="javascript:void(0)" onclick="openradovi(event, 'Eat');" id="myLink">
        <div class="w3-col s6 tablink">Mesta</div>
      </a>
      <a href="javascript:void(0)" onclick="openradovi(event, 'Drinks');">
        <div class="w3-col s6 tablink">Elementi</div>
      </a>
    </div>
    
    <div id="Eat" class="w3-container radovi w3-padding-48 w3-card">
    ...
    <div id="Drinks" class="w3-container radovi w3-padding-48 w3-card">
    <div class="w3-display w3-container w3-xlarge">
      &#8201<button onclick="document.getElementById('radovi4').style.display='block'" class="w3-button ">Paris 18</button>
      &nbsp&nbsp<button onclick="document.getElementById('radovi5').style.display='block'" class="w3-button ">Paris 18</button>
      &nbsp&nbsp<button onclick="document.getElementById('radovi6').style.display='block'" class="w3-button ">Paris 18</button>
      &nbsp&nbsp<button onclick="document.getElementById('radovi7').style.display='block'" class="w3-button ">Paris 18</button>
      </div>
    </div>  
...
<div id="prvi" class="w3-modal">
  ...
  <div  class="w3-row w3-padding" style="background-color:rgb(30, 30, 30)">
    ...
    <div class="scrollradovi" style="background-color:rgb(30, 30, 30)">
...
<div class="w3-container" id="kontakt" style="padding-bottom:32px;">
  <div class="w3-content" style="max-width:700px">
    <h5 class="w3-center w3-padding-48"><span class="w3-tag w3-wide">KONTAKT</span></h5>
    <p>Za detaljnije informacije i dogovor obratite nam se putem:</p><br>
...
<script>
// Tabbed radovi
function openradovi(evt, radoviName) {
  var i, x, tablinks;
  x = document.getElementsByClassName("radovi");
  ...
  document.getElementById(radoviName).style.display = "block";
