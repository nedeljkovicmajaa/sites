...
<div class="w3-top w3-content">
  <div class="w3-row w3-padding w3-black ">
    <div class="w3-col s3">
      <a href="#top" class="w3-button w3-block w3-black">START</a>
    </div>
    <div class="w3-col s3">
      <a href="#about" class="w3-button w3-block w3-black">ABOUT</a>
    </div>
    <div class="w3-col s3">
      <a href="#works" class="w3-button w3-block w3-black">WORKS</a>
    </div>
    <div class="w3-col s3">
...
<header class="w3-display-container " id="top">
  ...
  <div class="w3-display-bottomleft w3-padding-large">
    ...
    <br>
    <span class="w3-text-white">Kraljevo, Serbia</span>
  </div>
...
<div class="w3-container" id="about">
  <div class="w3-content" style="max-width:700px">
    ...
    <p>In addition to our full espresso and brew bar works, we serve fresh made-to-order breakfast and lunch sandwiches, as well as a selection of sides and salads and other good stuff.</p>
    
  </div>
</div>

<!-- works Container -->
<div class="w3-container" id="works">
  <div class="w3-content" style="max-width:700px">
 
    <h5 class="w3-center w3-padding-48"><span class="w3-tag w3-wide">WORKS</span></h5>
  
    <div class="w3-row w3-center w3-card w3-padding">
      <a href="javascript:void(0)" onclick="openworks(event, 'Eat');" id="myLink">
        <div class="w3-col s6 tablink">Places</div>
      </a>
      <a href="javascript:void(0)" onclick="openworks(event, 'Drinks');">
        <div class="w3-col s6 tablink">Elements</div>
      </a>
    </div>
    
    <div id="Eat" class="w3-container works w3-padding-48 w3-card">
    ...
    <div id="Drinks" class="w3-container works w3-padding-48 w3-card">
    <div class="w3-display w3-container w3-xlarge">
      &#8201<button onclick="document.getElementById('works4').style.display='block'" class="w3-button ">Paris 18</button>
      &nbsp&nbsp<button onclick="document.getElementById('works5').style.display='block'" class="w3-button ">Paris 18</button>
      &nbsp&nbsp<button onclick="document.getElementById('works6').style.display='block'" class="w3-button ">Paris 18</button>
      &nbsp&nbsp<button onclick="document.getElementById('works7').style.display='block'" class="w3-button ">Paris 18</button>
      </div>
    </div>  
...
<div id="prvi" class="w3-modal">
  ...
  <div  class="w3-row w3-padding" style="background-color:rgb(30, 30, 30)">
    ...
    <div class="scrollworks" style="background-color:rgb(30, 30, 30)">
...
<div class="w3-container" id="contact" style="padding-bottom:32px;">
  <div class="w3-content" style="max-width:700px">
    ...
    <p>For more information contact us via social networks:</p><br>
